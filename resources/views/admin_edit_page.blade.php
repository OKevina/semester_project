        ...
        <div class="hotel-admin">
            ...
            <div class="hotel-images-admin">
                @foreach ($hotel['images'] as $image)
                    ...
                    <form action="processes/edit_process.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="image_id" value="{{ $image['id'] }}">
                        <input type="hidden" name="hotel_id" value="{{ $hotel['id'] }}">
                        <input type="file" name="image_file" accept="image/*" required>
                        <button type="submit" name="update_image" onclick="return confirm('Are you sure you want to update this hotel?')">Update Image</button>
            ...
            <form action="processes/edit_process.php" method="post">
                <input type="hidden" name="hotel_id" value="{{ $hotel['id'] }}">
